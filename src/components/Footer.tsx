      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="mb-8 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mb-3 text-sm leading-relaxed text-gray-400">{t("disclaimer")}</p>
            <p className="mb-4 text-xs leading-relaxed text-gray-500">{t("responsibleGaming")}</p>
        ...
        <div className="mb-8 flex flex-col items-center justify-between gap-6 border-t border-grand-700/50 pt-8 md:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-xs text-gray-500">
            <Link href="/privacy" className="hover:text-grand-400">{t("privacy")}</Link>
            <Link href="/data-policy" className="hover:text-grand-400">{t("dataPolicy")}</Link>
          </div>
        </div>
